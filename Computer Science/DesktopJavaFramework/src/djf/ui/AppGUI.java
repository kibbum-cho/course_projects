...
public class AppGUI {
    ...
    public void activaterSaveAsExport(boolean ables) {
        // THIS TOGGLES WITH WHETHER THE CURRENT COURSE
        // HAS BEEN SAVED OR NOT
        saveAsButton.setDisable(!ables);
        exportButton.setDisable(!ables);
        // NOTE THAT THE NEW, LOAD, AND EXIT BUTTONS
        // ARE NEVER DISABLED SO WE NEVER HAVE TO TOUCH THEM
    }
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        fileToolbarPane.getChildren().add(space);
        ...
        //HBox redoUndoAbout = new HBox(redoButton, undoButton, aboutButton);
    ...
    public void markEdited(AppGUI gui){
