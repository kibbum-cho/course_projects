...
public class AppFileController {
	...
	PropertiesManager props = PropertiesManager.getPropertiesManager();
		...
		FileChooser fc = new FileChooser();
		fc.setInitialDirectory(new File(PATH_WORK));
		fc.setTitle(props.getProperty(SAVE_AS_WORK_TITLE));
		fc.getExtensionFilters().addAll(
		new ExtensionFilter(props.getProperty(WORK_FILE_EXT_DESC), props.getProperty(WORK_FILE_EXT)));
    ...
    public void handleExportRequest() {
        ...
        try {
            ...
            if (path != null) {
                String oldPath1 = "..\\CourseSiteGeneratorTester\\Syllabus";
                copy(oldPath1, path);
                String oldPath2 = "..\\CourseSiteGeneratorTester\\Schedule";
                copy(oldPath2, path);
                String oldPath3 = "..\\CourseSiteGeneratorTester\\Projects";
                copy(oldPath3, path);
                String oldPath4 = "..\\CourseSiteGeneratorTester\\Home";
                copy(oldPath4, path);
    ...
    private void saveForExport(File selectedFile) throws IOException {
	// SAVE IT TO A FILE
